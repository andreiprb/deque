...
* membrii de tip intreg "first_used_block", "last_used_block"
	...
	- index-ul primului block folosit poate fi 0 sau 1 (vezi constructor + metoda push_front())
	- index-ul ultimului block folosit poate fi n-1 sau n-2, unde n este dimensiunea buffer-ului de block-uri (vezi constructor + metoda push_back())
...
* metoda push_front()
	- metoda adauga la inceput valoarea trimisa prin parametru
...
* metoda push_back()
	- metoda adauga la final valoarea trimisa prin parametru
	- se incrementeaza "count"
...
* metoda pop_front()
	- daca "count" este 0, se apeleaza metoda clear()
...
* metoda insert()
	- daca index-ul introdus este mai mic ca 0, elementul se introduce prin metoda push_front()
	- daca index-ul introdus este mai mar sau egala cu "count", elementul se introduce prin metoda push_back()
